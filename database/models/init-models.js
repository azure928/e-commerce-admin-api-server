...
export default function initModels(sequelize) {
  ...
  issued_coupon.belongsTo(coupon_types, { as: "coupon_type", foreignKey: "coupon_type_id"});
  coupon_types.hasMany(issued_coupon, { as: "issued_coupons", foreignKey: "coupon_type_id"});
  orders.belongsTo(issued_coupon, { as: "issued_coupon", foreignKey: "issued_coupon_id"});
  issued_coupon.hasMany(orders, { as: "orders", foreignKey: "issued_coupon_id"});
